...
ovs_rpm="openvswitch-2.9.0-94.el7fdp.x86_64.rpm"
sel_link="http://download-node-02.eng.bos.redhat.com/brewroot/packages/openvswitch-selinux-extra-policy/1.0/8.el7fdp/noarch/openvswitch-selinux-extra-policy-1.0-8.el7fdp.noarch.rpm"
dpdk="1811-2"
...
result_file="mlx_1PF1VF.log"
tc_result_file="tc_mlx_1PF1VF.log"
...
netscout_xena_port=$(mlx_get_xena_port)
